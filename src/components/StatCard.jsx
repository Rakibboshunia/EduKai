const StatCard = ({ title, value, icon: Icon, iconBg }) => {
  return (
    <div className="group flex items-center justify-between bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 hover:border-brand-primary/20 p-6 sm:p-8 w-full transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
      {/* Accent Line */}
      ...
      <div>
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 group-hover:text-brand-primary transition-colors">{value}</h2>
      </div>
